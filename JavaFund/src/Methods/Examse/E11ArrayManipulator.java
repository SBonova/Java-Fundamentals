...
//            String typeCommand = commands[0];//exchange,max,min,first,last
//            switch (typeCommand){
//                case "exchange":
//                    int exchangeIndex = Integer.parseInt(commands[1]);
//                    //1. нов масив с елементите до втория индекс ->[1, 2, 3]
//                    //2. нов масив с елементи след втория масив -> [4, 5]
//                    //3. now masiv -> 2 i 1
//                    if (isValidIndex(exchangeIndex, numbers.length)){
//                        exchange(numbers, exchangeIndex);
//                    }else {
//                        System.out.println("Invalid index");
//                    }
//                    break;
...
//    int[] numbersAfterExchengeIndex = new int[numbers.length - exchangeIndex - 1];
//
//        for (int index = 0; index <= exchangeIndex; index++) {
//          int curentElement = numbers[index];
//          numbersToExchangeIndex[index] = curentElement;
//        }
//
//    }
////
